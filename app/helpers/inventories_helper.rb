module InventoriesHelper
  def inventories_section_toolbar(skip_config: false)
    items = [
      ...
      { label: 'Entrate',   path: itemins_path,                              icon: 'input',          can: 'manage_itemins',    group: :actions },
      { label: 'Uscite',    path: itemouts_path,                             icon: 'output',         can: 'manage_itemouts',   group: :actions },
