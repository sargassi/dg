module MainwareHelper
  def mainware_menu(active:)
    [
      ...
      { label: 'Ricerca',        path: mainware_index_path,          active: active == 'articoli',        icon: 'inventory_2',     can: 'manage_mainware' },
  ...
  def mainware_section_toolbar(skip_config: false)
    items = [
      ...
      { label: 'Ricerca',        path: mainware_index_path,          icon: 'inventory_2',     can: 'manage_mainware',      group: :nav },
