...
export default class extends Controller {
  ...
  _expand() {
    ...
    this.colpriceTargets.forEach((el) => el.classList.add("bg-green-50", "dark:bg-green-900/30"));
  }

  _collapse() {
    this.open = false;
    this.detailTargets.forEach((el) => el.classList.add("hidden"));
    this.colpriceTargets.forEach((el) => el.classList.remove("bg-green-50", "dark:bg-green-900/30"));
  }
}
