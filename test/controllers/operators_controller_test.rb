...
class OperatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator" do
    assert_difference("Operator.count") do
      post operators_url, params: { operator: { lastname: @operator.lastname, name: @operator.name, role: @operator.role } }
    end
  ...
  test "should update operator" do
    patch operator_url(@operator), params: { operator: { lastname: @operator.lastname, name: @operator.name, role: @operator.role } }
