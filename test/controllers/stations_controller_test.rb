...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference("Station.count") do
      post stations_url, params: { station: { description: @station.description, note: @station.note } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { description: @station.description, note: @station.note } }
