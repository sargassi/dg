...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference("Warehouse.count") do
      post warehouses_url, params: { warehouse: { address: @warehouse.address, cap: @warehouse.cap, city: @warehouse.city, civic: @warehouse.civic, code: @warehouse.code, latitude: @warehouse.latitude, longitude: @warehouse.longitude } }
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { address: @warehouse.address, cap: @warehouse.cap, city: @warehouse.city, civic: @warehouse.civic, code: @warehouse.code, latitude: @warehouse.latitude, longitude: @warehouse.longitude } }
